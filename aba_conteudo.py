# aba_conteudo.py
# Descrição: Adiciona a gestão de tabelas para o capítulo selecionado.
...
from dialogo_tabela import TabelaDialog # <-- Importa nosso novo editor
...
class AbaConteudo(QWidget):
    ...
    def _build_ui(self):
        ...
        left_layout.addWidget(QLabel("Estrutura do Documento (duplo clique para editar)"))
        ...
        # Painel Direito: Editor e Gerenciador de Tabelas
        right_panel = QWidget()
        ...
        # --- ## NOVO: Gerenciador de Tabelas do Capítulo ## ---
        self.label_tabelas = QLabel("Tabelas neste Tópico:")
        self.lista_tabelas = QListWidget()
        self.lista_tabelas.setMaximumHeight(150)
        
        tabelas_btn_layout = QHBoxLayout()
        btn_add_tabela = QPushButton("Adicionar Tabela")
        ...
        right_layout.addWidget(self.editor_capitulo, 3) # Ocupa 3/4 do espaço
        right_layout.addWidget(self.label_tabelas)
        right_layout.addWidget(self.lista_tabelas, 1) # Ocupa 1/4
        right_layout.addLayout(tabelas_btn_layout)
    ...
    def _carregar_capitulo_no_editor(self, item_atual, item_anterior):
        ...
        # Carrega as tabelas do capítulo
        self.lista_tabelas.clear()
    ...
    # --- ## NOVOS MÉTODOS para gerenciar as tabelas ## ---
    @QtCore.Slot()
    ...
    # (Restante dos métodos da classe sem alterações)
